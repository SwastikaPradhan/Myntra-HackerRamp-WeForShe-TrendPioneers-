...
from chatbot.chat import get_response, bot_name, load_model, load_data, load_products_from_csv
...
class ChatApp:
    ...
    def _on_speak_pressed(self):
        ...
        try:
            ...
            self._insert_message("Sorry, I did not understand the voice information you may try to speak again or can type the message in inout box.", "System")
